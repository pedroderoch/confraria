...
<body>
  ...
  <div class="limiter">
    <div class="container-login100" style="background-image: url('{{URL::asset('/login/images/img8.jpg') }}');">
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
        ...
        {{ csrf_field() }}
          ...
          <div class="wrap-input100 validate-input" data-validate="Password is required">
            ...
            <input class="input100" type="password" name="senha" placeholder="Type your password">
            <span class="focus-input100" data-symbol="&#xf190;"></span>
          </div>
